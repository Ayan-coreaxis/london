...
return new class extends Migration {
    public function up(): void
    {
        $settings = [
            ...
            ['key'=>'color_hero_bg',        'value'=>'#f8f4f0', 'type'=>'color',    'group'=>'design',   'label'=>'Hero Section Background'],

            ['key'=>'color_btn_primary_bg',  'value'=>'#1e3a6e','type'=>'color',    'group'=>'design',   'label'=>'Button Primary Background'],
            ['key'=>'color_btn_primary_text','value'=>'#ffffff', 'type'=>'color',    'group'=>'design',   'label'=>'Button Primary Text'],
            ['key'=>'color_nav_active',     'value'=>'#e8352a', 'type'=>'color',    'group'=>'design',   'label'=>'Nav Active/Hover Color'],
            // ── PRODUCT CARD COLORS ──
            ...
            // ── TYPOGRAPHY ──
            // Font family hardcoded hai CSS mein (local ABCGravity font use ho raha hai)
            // Admin dashboard mein Typography section bilkul nahi hai
            // ── HERO SECTION ──
            ...
            // ── HEADER ──
            ['key'=>'header_phone',         'value'=>'',          'type'=>'text',   'group'=>'header',   'label'=>'Header Phone (optional)'],
